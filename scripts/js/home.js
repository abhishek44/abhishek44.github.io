    ...
    function($, THREE, ShaderTerrain, OrbitControls, NormalMapShader, Detector, BufferGeometryUtils, anime) {
        ...
        function home() {
            this.init = function() {
                ...
                scene.background = new THREE.Color(0xFF97B2);
                scene.fog = new THREE.Fog(0xFF97B2, 2000, 4000);
                ...
                pointLight = new THREE.PointLight(0xFF97B2, 1.5);
            ...
            function render() {
                ...
                if (firstTime) {
                    ...
                    png.src = "./images/circle-colored-200.jpg"
                    png.width = 200;  
                    png.height = 200;
                    firstTime = false;
                }
